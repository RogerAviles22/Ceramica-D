    ...
    render() {
        return (
            <section className="row d-flex justify-content-center align-items-center py-3">
                ...
                <p className="welcome-text col-xl-4 col-md-5 col-12 mt-2 text-center">Pequeño emprendimiento dedicado a la creación de productos de cerámica realizados de forma artesanal.</p>
            </section>
        );
    }
}
